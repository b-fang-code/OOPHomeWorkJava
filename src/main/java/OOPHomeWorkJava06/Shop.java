 ...
 */
public class Shop implements Interface_CreateTelephone, Interface_SellTelephone, Interface_AddPhone {

   private ArrayList<Telephone> listTelephon;

    /**
     * Метод создания списка телефонов
     * @param listTelephone
     * @return
     */
    @Override
    ...
    /**
     * Метод продажи телефона со склада
     * @param listTelephone
     * @return
     */
    @Override
    ...
    /**
     * Метод добавления экземпляра телефона на склад
     * @param listTelephone
     * @return
     */
    @Override
